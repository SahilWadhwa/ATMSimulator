...
public class FiveHundredCurrencyDispenserTest {
    ...
    public void setUp() throws Exception {
        ...
        cashInLimit = Long.valueOf(FIVE_HUNDERED.getValue() * FIVE_HUNDRED_NOTE_COUNT);
        cashOutsideLimit = Long.valueOf(FIVE_HUNDERED.getValue() * (FIVE_HUNDRED_NOTE_COUNT + 10));
    }
    ...
    public void shouldDispenseAmountInMultipleOfFiveHundred() throws Exception {
        ...
        assertTrue("Incorrect Five Hundred currency notes initialized", cashDispensed.get(FIVE_HUNDERED).equals(10));
    }
